    ...
    <div class="container p-4 mt-4 bg-black">
        <div class="card bg-white p-4 m-2">
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tr>
                    <td> Nama Pemesan : {{ Auth::user()->name }}</td>
                    <td class="text-bold">Tanggal Pembayaran : {{ $transaksi->created_at }}</td>
                </tr>
                <tr>
                    <td> Telepon :{{ Auth::user()->telp }}</td>
                    <td class="text-bold">ID Transaksi : {{ $transaksi->order_id }}</td>
                    <td></td>
                    <td></td>
                </tr>
                <tr>
