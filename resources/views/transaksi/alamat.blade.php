...
<div class="container">
    <label class="text-lg">Lengkapi Alamat Anda</label>
    ...
    <div class="content flex justify-between">
        <div class="flex-1 p-2 m-2">
            <div class="content mb-2">
                ...
                <textarea name="alamat" class="form-control w-full px-3 py-1.5 rounded m-0 focus:text-gray-700 focus:bg-white" rows="3"placeholder="Alamat Lengkap"></textarea>
            @error('alamat')
        ...
        <div class="content mt-2">
            ...
            <input class="form-control" type="number" value="" name="kodepos">
            @error('kodepos')
                <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
        </div>
    ...
    <div class="flex-1 p-2 m-2">
            <select hidden class="form-control" name="province_origin" id="">
